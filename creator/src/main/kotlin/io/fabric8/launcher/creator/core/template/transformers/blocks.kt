...
data class FirstLastValue<out T>(public val value: T, public val isFirst: Boolean, public val isLast: Boolean)
...
public fun <T> Sequence<T>.withFirstLast(): Sequence<FirstLastValue<T>> = WithFirstLastSequence(this)
